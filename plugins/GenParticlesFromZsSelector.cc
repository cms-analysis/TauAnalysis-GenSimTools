#include "TauAnalysis/GenSimTools/plugins/GenParticlesFromZsSelector.h"
...
GenParticlesFromZsSelector::GenParticlesFromZsSelector(const edm::ParameterSet& cfg) 
{
...
GenParticlesFromZsSelector::~GenParticlesFromZsSelector() 
{ 
...
void GenParticlesFromZsSelector::produce(edm::Event& evt, const edm::EventSetup& es) 
{
...
DEFINE_FWK_MODULE(GenParticlesFromZsSelector);
