...
selectedGenTauDecaysToHadronsEta21Individual = copy.deepcopy(selectedGenTauDecaysToHadronsEta21Cumulative)
...
selectedGenTauDecaysToHadronsPt20Individual = copy.deepcopy(selectedGenTauDecaysToHadronsPt20Cumulative)
selectedGenTauDecaysToHadronsPt20Individual.src = selectedGenTauDecaysToHadrons.src
